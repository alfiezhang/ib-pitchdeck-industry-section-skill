                ...
                json.dumps(
                    {
                        ...
                        "error": str(exc),
                        "run_dir": str(run_dir),
                        "repair_hint": "Run scripts/workflow.py status/next, fix the failed upstream gate, then rerun compile_deck_blueprint.py. Do not compile derived renderer artifacts from a failed formal run.",
                    },
                    ensure_ascii=False,
                    indent=2,
                )
