    ...
    if isinstance(plan_data, dict):
        ...
        if plan_errors:
            ...
            _append_validation_issue(
                ...
                forbidden_action="Do not execute source_reviews from unexecuted FS rows.",
            )
    ...
    *,
    ...
    if result.get("is_valid") is False:
        ...
        _append_validation_issue(
            ...
            recommended_action="Repair reviewed source entries and align source reviews with search log and source archive.",
            forbidden_action="Do not add unreviewed source rows to claim upstream layers.",
        )
