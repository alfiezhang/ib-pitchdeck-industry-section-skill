...
def main() -> None:
    ...
    checks = {
        ...
        "recommended_commands": [
            ...
            "./run_pipeline.sh --work-root <workspace> --case-name <case> --deck-blueprint <run>/deck_blueprint.json",
            "./run_pipeline.sh --resume-active --work-root <workspace> --case-name <case> --deck-blueprint <run>/deck_blueprint.json  # only to continue an existing attempt",
