...
def first_failed_gate(run_dir: Path) -> dict[str, Any]:
    ...
    checks = [
        ...
        },
        {
            ...
            "allowed": ["run_formal_research_execution", "fix_formal_research_execution_report", "rerun_formal_research_execution_validation"],
            "forbidden": ["write_research_pack", "compile_deck_blueprint", "run_ppt_pipeline", "publish_final"],
        },
        {
        ...
        },
        {
            ...
            "allowed": ["fix_chart_data_or_metric_reconciliation", "rerun_chart_metric_binding_validation"],
            "forbidden": ["run_ppt_pipeline", "publish_final"],
        },
        {
            ...
            "allowed": ["fix_renderer_spec_or_research_pack", "rerun_content_quality_validation"],
            "forbidden": ["run_ppt_pipeline", "publish_final"],
        },
        {
