...
risks, source preferences, and research topics belong in artifacts/formal_search_plan.json
or industry_research_pack.md unless the user explicitly provided them.
    ...
    for path in sorted(HIGH_RISK_INFERRED_PATHS):
        ...
        if is_non_empty(value) and path not in user_provided and not allow_enriched:
            errors.append(
                ...
                "put planner-generated items in artifacts/formal_search_plan.json."
            )
