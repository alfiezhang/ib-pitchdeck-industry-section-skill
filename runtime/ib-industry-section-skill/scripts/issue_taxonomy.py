#!/usr/bin/env python3
"""Canonical industry issue taxonomy shared by research and analysis gates."""
...
ISSUE_TOPICS_BY_AREA = {
    ...
    "key_trends_drivers": {
        ...
        "channel_or_go_to_market_shift",
        "mna_and_consolidation",
    },
    "competitive_landscape": {
        ...
        "channel_footprint",
        "recent_developments",
        "valuation_snapshot_peer_fact",
    },
    "competitive_dynamics": {
        "basis_of_competition",
        "winners_losers",
        "new_entrants",
        "substitutes_or_adjacent_risk",
...
VALID_SUBISSUES = set().union(*ISSUE_TOPICS_BY_AREA.values())
