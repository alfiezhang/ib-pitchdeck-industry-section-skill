...
echo "  $SOURCE_DIR/industry_research_pack.md"
...
echo "  (page_evidence_contract.json and renderer_spec.json are generated from deck_blueprint by scripts/compile_deck_blueprint.py)"
echo ""
