...
def _build_error_repair_plan(errors: list[str], repair_targets: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "instruction": (
            "Use the mapped repair targets first. After edits rerun scripts/qc/validators/generation/validate_deck_blueprint.py, "
            "scripts/generation/compile_deck_blueprint.py, and scripts/qc/validators/generation/validate_renderer_spec.py."
        ),
    }
