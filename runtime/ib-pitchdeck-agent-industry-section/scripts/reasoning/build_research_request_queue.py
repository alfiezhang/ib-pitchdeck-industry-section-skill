...
def main() -> int:
            ...
            requests.append(
                {
                    ...
                    "required_source_type_hint": "public_search",
    ...
    payload = {
        ...
        "requests": requests,
        "build_rule": "requests are generated only from banker_page_pack.research_requests and slide open_questions; unresolved requests stay caveat/diligence-only until formal execution creates evidence",
    }
