...
echo "  $SOURCE_DIR/banker_page_pack.json"
...
echo "  (deck_blueprint.json, page_evidence_contract.json, and renderer_spec.json are generated from banker_page_pack.json by scripts/generation/compile_banker_page_pack.py)"
echo ""
