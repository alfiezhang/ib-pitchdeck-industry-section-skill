...
DEFAULT_RENDER_LAYOUTS_PATH = _IB_RUNTIME_ROOT / "templates" / "render_layouts.json"
DEFAULT_TEMPLATE_PROFILE_PATH = _IB_RUNTIME_ROOT / "templates" / "template_profile.json"
