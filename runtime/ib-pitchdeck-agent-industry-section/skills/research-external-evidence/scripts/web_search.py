...
Usage:
  python skills/research-external-evidence/scripts/web_search.py -q "中国目标行业市场规模"
  python skills/research-external-evidence/scripts/web_search.py -q "示例公司 营收" --provider tavily -n 3
  python skills/research-external-evidence/scripts/web_search.py --queries "目标行业市场规模" "示例公司营收" "目标行业趋势" -o tmp/search_batch.json
  python skills/research-external-evidence/scripts/web_search.py -q "中国目标细分市场发展现状及未来趋势分析" --split-query
  python skills/research-external-evidence/scripts/web_search.py -q "年度报告 营收" --site cninfo.com.cn --site-mode priority
  python skills/research-external-evidence/scripts/web_search.py -q "行业趋势" --source-pack china_official --source-registry templates/source_registry.json
  python skills/research-external-evidence/scripts/web_search.py -q "行业趋势" --use-default-packs --source-registry templates/source_registry.json
...
DEFAULT_SOURCE_REGISTRY = _IB_RUNTIME_ROOT / "templates" / "source_registry.json"
