...
def _build_error_repair_plan(errors: list[str], repair_targets: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "instruction": (
            "Use the mapped repair targets first. After edits rerun skills/qc/scripts/validators/generation/validate_deck_blueprint.py, "
            "skills/generation/scripts/compile_deck_blueprint.py, and skills/qc/scripts/validators/generation/validate_renderer_spec.py."
        ),
    }
...
def _active_fields_hint(slide_no: int, page_type: str, fields: list[str]) -> str:
    ...
    return (
        ...
        f"Inspect with: python skills/generation/scripts/describe_slide_fields.py --slide-no {slide_no} --page-type {page_type}"
    )
...
def build_warning_repair_plan(warnings: list[str]) -> dict[str, Any]:
    ...
    return {
        ...
        "rerun_steps": [
            ...
            "skills/qc/scripts/validators/generation/validate_renderer_spec.py",
