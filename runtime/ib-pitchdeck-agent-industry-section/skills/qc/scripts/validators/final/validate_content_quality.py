...
DEFAULT_LAYOUT_BUDGET_PATH = _IB_RUNTIME_ROOT / "templates" / "layout_budget.json"
DEFAULT_DRILLDOWN_ROLE_LIBRARY_PATH = _IB_RUNTIME_ROOT / "templates" / "drilldown_role_library.json"
# ── Helpers ──────────────────────────────────────────────────────
...
DEFAULT_CONTENT_REPAIR_PROFILE = {
    ...
    "rerun_steps": [
        ...
        "skills/qc/scripts/validators/final/validate_content_quality.py",
    ],
...
CONTENT_REPAIR_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "VISIBLE_CLAIM_BINDING": {
        ...
        "rerun_steps": [
            "skills/qc/scripts/repair_visible_metric_claims.py",
            "skills/generation/scripts/compile_deck_blueprint.py",
            "skills/qc/scripts/validators/final/validate_chart_metric_binding.py",
            "skills/qc/scripts/validators/final/validate_content_quality.py",
        ],
    ...
    "EVIDENCE_LINKAGE": {
        ...
        "rerun_steps": [
            "skills/qc/scripts/validators/knowledge/validate_research_pack.py",
