...
def runtime_diagnostic_payload() -> dict[str, object]:
    ...
    checks = {
        ...
        "required_entrypoints": {
            ...
            "validate_stage_gate": script_exists("skills/qc/scripts/validators/final/validate_stage_gate.py"),
            "validate_final_delivery": script_exists("skills/qc/scripts/validators/final/validate_final_delivery.py"),
        },
